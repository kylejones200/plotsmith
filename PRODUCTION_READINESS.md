...
- `disallow_untyped_defs = false` (TODO: Enable gradually)
- `ignore_missing_imports = true` (TODO: Add type stubs)
...
- Only tests Python 3.12 (intentional - Python 3.12+ only requirement)
...
- Migration guides (to be added as needed for breaking changes)
...
- Memory profiling (not yet implemented, but benchmarks help identify issues)
...
- Some code duplication may remain (ongoing improvement)
...
### 15. No Model/Plot Serialization **DEFERRED**
...
- Development container (DevContainer) - Not implemented
...
- Type coverage to 100% - In progress (gradual enablement)
- Docstring coverage checking - Not implemented
...
- Issue templates - Not implemented
...
1. Automated dependency updates (Dependabot removed, manual process)
...
- **Type Coverage**: **~70%** (improved, target 90%+)
...
- Enable strict type checking gradually (ongoing)
- Docstring coverage checking (nice-to-have)
- Additional performance optimizations (ongoing)
- Migration guides (as needed for breaking changes)
