# Contributing to PlotSmith

Thank you for your interest in contributing to PlotSmith! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/YOUR_USERNAME/plotsmith.git
cd plotsmith
```
...
```bash
# Format code
black plotsmith tests

# Check linting
flake8 plotsmith tests
```
...
# Run with coverage
pytest tests/ --cov=plotsmith --cov-report=html
```
...
- Code is formatted: black plotsmith tests
- Linting passes: flake8 plotsmith tests
